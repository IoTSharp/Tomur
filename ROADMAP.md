...
1. M1-M3 的编译、自动化测试、CLI/API 实跑和跨平台资源释放尚未执行，统一列入详细路线图 M14。
2. M4-M13 先完成基础代码；kernel/oracle 对齐、tokenizer、forward、API、性能、发布兼容与完整模型验证统一在 M14 执行。
