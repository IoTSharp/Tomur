...
| 04 | R15 | ⏳ 计划中 | Runtime 偏好、下载队列与 Settings 写入 |
| 05 | R16 | ⏳ 计划中 | 回归 smoke、发布证据与长期维护 |
...
3. 不新增外部服务进程，不拆分 .NET 项目，不把 OpenVINO 或 SYCL 运行时细节暴露成用户必须理解的前置概念。
...
### 04. ⏳ R15: Runtime 偏好、下载队列与 Settings 写入
