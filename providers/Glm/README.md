...
Targeted format and API evidence is recorded in [R15 packed GLM smoke](../../docs/r15-packed-glm-smoke.md). The pre-converted full model is 357.4 GiB and has not been loaded on the current machine because no local disk has enough free space.
